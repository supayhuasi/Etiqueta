...
try {
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS ecommerce_compras (
            ...
            subtotal DECIMAL(10,2) NOT NULL,
            total DECIMAL(10,2) NOT NULL,
            estado VARCHAR(30) NOT NULL DEFAULT 'orden_pendiente',
            recepcion_estado VARCHAR(30) NOT NULL DEFAULT 'pendiente',
