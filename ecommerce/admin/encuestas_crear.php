...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO ecommerce_encuestas (titulo, descripcion, fecha_entrega, token_publico, activo) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$titulo, $descripcion, $fecha_entrega, $token, $activo]);
        ...
        foreach ($preguntas as $p) {
            ...
            $stmtQ->execute([$encuesta_id, $texto, $tipo, $opciones_json, $orden]);
            $orden++;
        }
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted">Genera una encuesta pública</p>
    </div>
        ...
        <form method="POST" id="formEncuesta">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">El link público expira a los 30 días</small>
                </div>
            </div>
            <div class="mt-3">
...
function agregarPregunta(data = null) {
    preguntaIndex++;
    const item = data || { texto: '', tipo: 'texto', opciones: '' };
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="preguntas[${preguntaIndex}][texto]" value="${item.texto}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3" id="opciones_${preguntaIndex}" style="display:${item.tipo === 'opcion' ? 'block' : 'none'};">
                        ...
                        <input type="text" class="form-control" name="preguntas[${preguntaIndex}][opciones]" value="${item.opciones}" placeholder="Ej: Rojo, Azul, Verde">
                    </div>
                </div>
