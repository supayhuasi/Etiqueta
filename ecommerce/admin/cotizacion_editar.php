                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control item-precio" id="precio_${itemIndex}" name="items[${itemIndex}][precio]" value="${item.precio_unitario}" step="0.01" min="0" required onchange="calcularTotales()">
                        </div>
                    </div>
                    <div class="col-md-2">
