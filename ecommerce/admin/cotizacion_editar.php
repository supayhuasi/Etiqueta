            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="items[${itemIndex}][nombre]" value="${item.nombre}" required onchange="calcularTotales()">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Descripción</label>
                        <input type="text" class="form-control" name="items[${itemIndex}][descripcion]" value="${item.descripcion || ''}" onchange="calcularTotales()">
                    </div>
                    <div class="col-md-1">
                        <label class="form-label">Ancho</label>
                        <input type="number" class="form-control" name="items[${itemIndex}][ancho]" value="${item.ancho || ''}" step="0.01" min="0" onchange="calcularTotales()">
                    </div>
                    <div class="col-md-1">
                        <label class="form-label">Alto</label>
                        <input type="number" class="form-control" name="items[${itemIndex}][alto]" value="${item.alto || ''}" step="0.01" min="0" onchange="calcularTotales()">
                    </div>
                    <div class="col-md-1">
                        <label class="form-label">Cant. *</label>
                        <input type="number" class="form-control item-cantidad" name="items[${itemIndex}][cantidad]" value="${item.cantidad}" min="1" required onchange="calcularTotales()">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">Precio Unit. *</label>
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" class="form-control item-precio" name="items[${itemIndex}][precio]" value="${item.precio_unitario}" step="0.01" min="0" required onchange="calcularTotales()">
                        </div>
                    </div>
                </div>
