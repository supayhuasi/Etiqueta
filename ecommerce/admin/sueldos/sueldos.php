...
$minutos_extras_por_empleado = sueldosCalcularMinutosExtrasMesPorEmpleado($pdo, $mes_filtro);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-3 mt-md-0">
                            <div class="text-center">
                                ...
                                <h3 class="<?= $total_minutos_extras_mes < 0 ? 'text-danger' : 'text-warning' ?>"><?= (int)$total_minutos_extras_mes ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($minutos_extras_emp > 0): ?>
                                    <span class="badge bg-warning text-dark" title="Minutos recuperados / extras respecto al horario"><?= $minutos_extras_emp ?> min</span>
                                <?php elseif ($minutos_extras_emp < 0): ?>
                                    <span class="badge bg-danger" title="Minutos negativos: llegadas tarde no recuperadas u otras salidas anticipadas"><?= $minutos_extras_emp ?> min</span>
                                <?php else: ?>
