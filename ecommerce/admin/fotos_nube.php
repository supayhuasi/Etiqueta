        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <form method="POST" class="mb-4">
                    ...
                    <input type="hidden" name="folder" value="<?= admin_h($current_folder) ?>">
                    <label class="form-label">Crear carpeta</label>
                ...
                <?php if ($current_folder !== ''): ?>
                    <form method="POST" class="mt-4" onsubmit="return confirm('¿Seguro que querés eliminar esta carpeta y todo su contenido?');">
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header bg-white d-flex justify-content-between align-items-center gap-3 flex-wrap">
                ...
                <a href="fotos_nube.php" class="btn btn-sm btn-outline-secondary">Inicio</a>
            </div>
            <div class="card-body">
                ...
                <?php else: ?>
                    ...
                    <?php if (!empty($files)): ?>
                        <form method="POST" id="fotos-download-form">
                            <input type="hidden" name="accion" value="descargar_seleccionados">
                            <div class="d-flex justify-content-between align-items-center gap-2 mb-3 flex-wrap">
                                <div class="small text-muted">Seleccioná las fotos que quieras descargar.</div>
                                <button type="submit" class="btn btn-primary btn-sm">Descargar seleccionadas</button>
                            </div>
                                ...
                                <?php foreach ($files as $file): ?>
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="card h-100 shadow-sm">
                                            <img src="../uploads/fotos_nube/<?= admin_h(str_replace('\\', '/', $file['rel'])) ?>" class="card-img-top" alt="<?= admin_h($file['name']) ?>" style="height: 180px; object-fit: cover;">
